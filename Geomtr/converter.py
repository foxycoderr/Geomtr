...
class Converter:
    ...
    @staticmethod
    def convert_objects(object_keywords):  # TODO: add angle creation when creating rectangle
        Logger.log("Started object conversion", "converter")
        objects = []
        for obj in object_keywords:
            if obj[0] in ["rectangle", "triangle"]:
                points = list(obj[1])
    ...
    @staticmethod
    def convert_properties(property_keywords, objects):
    ...
    @staticmethod
    def validate(object_keywords, property_keywords):
        print("Validating problem logic.")
        obj_valid = True
        obj_errors = []
        for object_kw in object_keywords:
        ...
        prop_valid = True
        prop_errors = []
        for property_kw in property_keywords:
        ...
        if obj_valid is True and prop_valid is True:
